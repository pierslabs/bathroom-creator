/**
 * Layout interior de un mueble (cabinet). Lógica PURA: entra el tamaño, sale
 * dónde van las baldas y si hay divisor. Sin Three ni React — testeable sola.
 *
 ...
 * Un mueble de 0.9 m → 2 baldas; de 1.8 m → 4. Nunca negativo.
 */
...
/** Layout completo del mueble: baldas + divisor, listo para dibujar. */
